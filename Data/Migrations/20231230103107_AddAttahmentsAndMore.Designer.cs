...
namespace HomewOurK.Persistence.Migrations
{
    ...
    [Migration("20231230103107_AddAttahmentsAndMore")]
    partial class AddAttahmentsAndMore
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HomewOurK.Domain.Entities.Attachments", b =>
                {
                    ...
                    b.HasIndex("SubjectsId", "SubjectsGroupId");
            ...
            modelBuilder.Entity("HomewOurK.Domain.Entities.UsersGroups", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTime?>("AverageHomeworkCompletionTime")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("GroupsUsers", b =>
                {
                    b.HasOne("HomewOurK.Domain.Entities.Groups", null)
                        .WithMany()
                        .HasForeignKey("GroupsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HomewOurK.Domain.Entities.Users", null)
                        .WithMany()
            ...
            modelBuilder.Entity("HomewOurK.Domain.Entities.Attachments", b =>
                {
                    ...
                    b.HasOne("HomewOurK.Domain.Entities.Subjects", "Subjects")
                        .WithMany()
            ...
            modelBuilder.Entity("HomewOurK.Domain.Entities.UsersGroups", b =>
                {
                    b.HasOne("HomewOurK.Domain.Entities.Groups", "Groups")
                        .WithMany("LevelInGroups")
                        .HasForeignKey("GroupsId");

                    b.HasOne("HomewOurK.Domain.Entities.Users", "Users")
                        .WithMany("LevelInGroups")
                        .HasForeignKey("UsersId");
